...
const siteUrl = "https://scrovolakka.github.io/inkloom";
...
export const metadata: Metadata = {
  ...
  title,
  description,
  openGraph: { title, description, images: [{ url: `${siteUrl}/og.png`, width: 1730, height: 909, alt: "INKLOOM — 2-COLOR IMAGE LAB" }] },
